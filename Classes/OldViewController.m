...
-(void)tableUpdateTimerFired:(NSTimer *)timer
{
    /*
    strayArray = [nuStore newOtherValues];
    
    [thisIsTableView reloadData];
     */
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    /*
    tableUpdateTimer = [NSTimer scheduledTimerWithTimeInterval:3 target:self selector:@selector(tableUpdateTimerFired:) userInfo:nil repeats:YES];
*/
		 ...
		 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	//[cell setBackgroundColor:[UIColor colorWithRed:69.0/255.0 green:156.0/255.0 blue:48.0/255.0 alpha:1.0]];
...
- (void)displayMailComposerSheet
{
	...
	NSString *emailBody = @"System Information";
